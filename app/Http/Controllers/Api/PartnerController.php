...
class PartnerController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'same_day_transfer_fee_white' => 'nullable|numeric|min:0',
            'same_day_transfer_fee_green' => 'nullable|numeric|min:0',
            'same_day_transfer_fee_electric' => 'nullable|numeric|min:0',
            'same_day_transfer_fee_tricycle' => 'nullable|numeric|min:0',
            'overnight_transfer_fee_white' => 'nullable|numeric|min:0',
            'overnight_transfer_fee_green' => 'nullable|numeric|min:0',
            'overnight_transfer_fee_electric' => 'nullable|numeric|min:0',
            'overnight_transfer_fee_tricycle' => 'nullable|numeric|min:0',
        ]);
