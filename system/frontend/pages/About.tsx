      ...
      {!loading && stores.length > 0 && (
        <section className="py-6 sm:py-8 md:py-10">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            {/* 上方橫線 */}
            <div className="border-t border-gray-200 dark:border-gray-700 mb-4 sm:mb-6"></div>
            ...
            <div className="space-y-6 sm:space-y-8">
              {stores.map((store) => (
                <div key={store.id}>
                  ...
                  {/* 每個商店圖片區域下方的淡色背景區域和灰色橫線 */}
                  <div className="bg-gray-50/20 dark:bg-gray-800/10 -mx-4 sm:-mx-6 px-4 sm:px-6 py-2 sm:py-3">
            ...
            {/* 下方橫線 */}
            <div className="border-b border-gray-200 dark:border-gray-700 mt-4 sm:mt-6"></div>
          </div>
        </section>
      )}
    </div>
