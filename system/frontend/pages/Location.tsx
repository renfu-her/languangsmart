...
const Location: React.FC = () => {
  ...
  const structuredData = {
    ...
    '@type': 'LocalBusiness',
    name: '蘭光電動機車',
    description: '蘭光電動機車各地服務據點位置，歡迎您前來門市參觀選車，我們提供最專業的服務與諮詢。',
      ...
      <header className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-[#f0f4ff] text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-500 max-w-xl mx-auto text-sm sm:text-base px-4">
            蘭光電動機車<span className="font-bold bg-gray-100 px-2 py-1 rounded">各地服務據點位置</span>，歡迎您前來門市參觀選車，我們提供最專業的服務與諮詢。
          </p>
